...
const MainView = ({info}) => {
  ...
  const style = { textColor: `${window.getComputedStyle(document.documentElement).getPropertyValue('--resume-header-color') === "white" ? "white" : "black"}`}
    ...
    <>
      <div className='general-information'>
        ...
        <div className="contact-info">
          <div>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6" style={style}>
